package com.example.musicdownload.ui
...
private const val DEFAULT_SCALE = 8f
private const val MAX_SCALE = 15f
private const val BASE_DURATION = 300L
private const val VARIABLE_DURATION = 300L

class BottomNavigationViewWithIndicatorDownload: BottomNavigationView, NavigationBarView.OnItemSelectedListener
{
